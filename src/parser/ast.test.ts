...
const EXPECTED_AST_NODES: { input: string[]; expected: InternalASTNode[] }[] = [
  {
    ...
    expected: [
      { id: '0', arg: 'file.txt', type: 'argument' },
      {
        id: '1',
        arg: '--verbose',
        type: 'option',
  ...
  },
  {
    ...
    expected: [
      { id: '0', arg: '-a', type: 'option', key: 'a', value: null },
      { id: '1', arg: '--beta=2', type: 'option', key: 'beta', value: '2' },
      { id: '2', arg: '-c=see', type: 'option', key: 'c', value: 'see' },
      { id: '3', arg: 'z', type: 'argument' },
    ],
  },
  {
    input: [
    ...
    expected: [
      ...
      { id: '3', arg: 'ARG', type: 'argument' },
      { id: '4', arg: '-x', type: 'option', key: 'x', value: null },
      {
        id: '5',
